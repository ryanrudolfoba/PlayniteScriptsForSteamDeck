...
If Steam Deck is running on battery, the script will set the TDP to 3W.
...
Write-output "Steam Deck is running on battery. Setting TDP to 3W. Please wait"
Start-Process $RyzenAdjInstallLocation -ArgumentList "--stapm-limit=500 --slow-limit=3000 --fast-limit=3000" -Verb runas
exit }
