...
If Steam Deck is running on battery, the script will set the TDP to 15W.
...
Write-output "Steam Deck is running on battery. Setting TDP to 15W. Please wait"
Start-Process $RyzenAdjInstallLocation -ArgumentList "--stapm-limit=1500 --slow-limit=15000 --fast-limit=15000" -Verb runas
exit }
