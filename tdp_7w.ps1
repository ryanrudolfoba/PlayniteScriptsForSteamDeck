...
If Steam Deck is running on battery, the script will set the TDP to 7W.
...
Write-output "Steam Deck is running on battery. Setting TDP to 7W. Please wait"
Start-Process $RyzenAdjInstallLocation -ArgumentList "--stapm-limit=700 --slow-limit=7000 --fast-limit=7000" -Verb runas
exit }
